...
namespace texto
{
    public class RetiraCaracteresEspeciais
    {
        public static string RemoveSpecialCharacters(string text, bool allowSpace = false) // AllowSpace = false: Tira os espaços. AllowSpace = true: Não tira os espaços.
        {
            string ret;
